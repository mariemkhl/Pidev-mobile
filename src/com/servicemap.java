...
import com.entities.map;
import com.sstatic.staticpath;
...
public class servicemap {
 ...
 public boolean addmap(map m) {
        ...
        String url = staticpath.BASE_URL + "addjson/" + m.getNomplace() + "/" + m.getDescription()  + "/" + m.getLien()  + "/" + m.getImage()  + "/" + m.getLongitude()  + "/" + m.getLatitude()  + "/" + m.getCategorie() +"/";
    ...
    public ArrayList<map> getAllmap() {
        String url = staticpath.BASE_URL + "mapdata";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
...
int userid=66;
        ...
        //String url = Statics.BASE_URL + "create?name=" + t.getName() + "&status=" + t.getStatus();
        String url = staticpath.BASE_URL + "modifjson/" + m.getId() + "/" +userid ;
...
int userid=66;
        ...
        //String url = Statics.BASE_URL + "create?name=" + t.getName() + "&status=" + t.getStatus();
        String url = staticpath.BASE_URL + "deletejson/" + m.getId() + "/" +userid ;
