package com.artisty.gui.front.reservations;
    ...
    private void addGUIs() {
        ...
        Fact.addActionListener((evv) -> {
            ...
            if (Dialog.show("Confirmation", "Voulez-vous obtenir detail de l'evenement en forme pdf  ?", "Oui", "Non")) {
                ...
                try {
                    ReservationsService.getInstance().recupererpdf(reservations);
                    
                    Dialog.show("PDF ",
                            "Enregistré avec succés", "", "OK");
                } catch (DocumentException ex) {
                   // Logger.getLogger(AfficherToutReservations.class.getName()).log(Level.SEVERE, null, ex);
