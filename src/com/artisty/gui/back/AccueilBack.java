...
public class AccueilBack extends Form {
    ...
    private Button makeEventsButton() {
        ...
        button.addActionListener(action -> new com.artisty.gui.back.event.AfficherToutEvent(this).show());
        return button;
    }
    ...
    private Button makeReservationssButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.artisty.gui.back.reservations.AfficherToutReservations(this).show());
        return button;
    }
