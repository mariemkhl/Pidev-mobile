...
public class EventService {
    ...
    public ArrayList<Event> getAll() {
        ...
        cr = new ConnectionRequest();
        cr.setUrl("http://127.0.0.1:8000/mobile" + "/event");
    ...
    public int add(Event event) {
        ...
        cr.setUrl("http://127.0.0.1:8000/mobile" + "/event/add");
    ...
    public int edit(Event event, boolean imageEdited) {
        ...
        cr.setHttpMethod("POST");
        cr.setUrl("http://127.0.0.1:8000/mobile" + "/event/edit");
...
*/
    ...
    public int delete(int eventId) {
        cr = new ConnectionRequest();
        cr.setUrl("http://127.0.0.1:8000/mobile" + "/event/delete");
        cr.setHttpMethod("POST");
