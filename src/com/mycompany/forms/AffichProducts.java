...
//    generateQRCode(product.getId_p(), new Callback<EncodedImage>() {
//        public void onSuccess(EncodedImage result) {
//            // Display the QR code image
//            Dialog.show("QR Code", new ImageViewer(result));
//        }
//
...
//    });
//});
//qrCodeButton.setUIID("QRCodeButton"); // Set a custom UIID for styling purposes
//Container qrCodeButtonContainer = FlowLayout.encloseCenter(qrCodeButton);
//productContainer.add(qrCodeButtonContainer);
